...
public class CalendarActivity extends AppCompatActivity implements EventAdapter.OnClick {
    ...
    private void renderCalendarDays() {
        calendarView.setDayBinder(new MonthDayBinder<CalendarActivity.DayViewContainer>() {
            @NonNull
            @Override
            public CalendarActivity.DayViewContainer create(@NonNull View view) {
                return new CalendarActivity.DayViewContainer(view);
            }

            @Override
            public void bind(@NonNull CalendarActivity.DayViewContainer container, CalendarDay calendarDay) {
    ...
    private void renderCalendarHeader() {
        calendarView.setMonthHeaderBinder(new MonthHeaderFooterBinder<ViewContainer>() {
            ...
            public ViewContainer create(@NonNull View view) {
                return new CalendarActivity.MonthViewContainer(view);
            }
    ...
    public void onClick(int position) {
        ...
        Intent iViewEvent = new Intent(CalendarActivity.this, ViewEventActivity.class);
